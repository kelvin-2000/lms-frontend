...
export default function CourseDetailPage({ params }: { params: { id: string } }) {
  // In a real app, we would fetch the course data using the ID from params
            ...
            <div>
              ...
              <div className="flex items-center space-x-4 mb-6">
                <div className="flex items-center">
                  ...
                  <span className="ml-2">{course.rating.toFixed(1)} ({course.ratingCount} ratings)</span>
                </div>
                <span>|</span>
                <div className="flex items-center">
              ...
              <div className="flex items-center mb-6">
                <div className="flex items-center mr-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-indigo-100">{course.instructor.title}</p>
                  </div>
                </div>
              </div>
              ...
              <div className="flex flex-wrap gap-4">
                <button className="px-6 py-3 bg-white text-indigo-600 font-medium rounded-lg hover:bg-indigo-50 transition-colors">
                  Enroll Now {course.price === 'Free' ? '(Free)' : `($${typeof course.price === 'number' ? course.price.toFixed(2) : course.price})`}
                </button>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                      ...
                      <div className="flex-1">
                        ...
                        <div className="flex items-center text-sm">
                          <button className="text-indigo-600 hover:text-indigo-800 font-medium">
                            View replies ({discussion.replies})
                          </button>
                        </div>
                      </div>
                    </div>
          ...
          <div>
            <div className="bg-white rounded-lg shadow-sm p-6 sticky top-6">
              ...
              <div className="mb-4">
                <p className="text-gray-500">{course.totalVideos} videos • {course.duration}</p>
              </div>
              
              <div className="space-y-4 mb-6">
                {course.videos.map(video => (
                  <div key={video.id} className="flex items-start p-3 border border-gray-200 rounded-lg hover:bg-gray-50 transition-colors">
