...
const mockJobDetails: JobDetails = {
  ...
  company: {
    ...
    about:
      'TechCorp is a leading technology company specializing in web and mobile application development. We work with clients across various industries to create innovative digital solutions that drive business growth.',
  ...
  jobType: 'full-time',
  description:
    'We are looking for a skilled Frontend Developer to join our team. The ideal candidate will have strong experience with React, TypeScript, and modern frontend frameworks. You will be responsible for developing user interfaces for our web applications, collaborating with backend developers, and ensuring high-quality, responsive design implementation.',
  responsibilities: [
...
export default function JobDetailPage({}: { params: { id: string } }) {
  ...
  const daysLeft = Math.ceil(
    (job.deadline.getTime() - today.getTime()) / (1000 * 60 * 60 * 24),
  );
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          <div className="flex flex-col md:flex-row md:items-center md:justify-between">
            ...
            <div className="mt-4 md:mt-0 flex flex-wrap gap-2">
              <span
                className={`px-3 py-1 rounded-full text-xs font-medium ${getJobTypeColor(job.jobType)} capitalize`}
              >
                {job.jobType}
              </span>
              ...
              <div className="flex items-center mb-4">
                ...
                <div>
                  ...
                  <p className="text-gray-500 text-sm">
                    {job.company.industry} • {job.company.employeesCount}{' '}
                    employees
                  </p>
                </div>
              </div>
              ...
              <div className="mb-6">
                <div className="flex items-center justify-between mb-2">
                  ...
                  <span className="text-gray-900">
                    {format(job.postedDate, 'MMMM d, yyyy')}
                  </span>
                </div>
