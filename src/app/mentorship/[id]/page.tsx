...
const mockMentorshipProgram: MentorshipProgram = {
  ...
  mentorAvatar: '/assets/mentors/sarah-johnson.jpg',
  mentorBio: 'I\'m a Senior Frontend Engineer at Google with over 10 years of experience in building complex web applications. I specialize in React, TypeScript, and modern JavaScript frameworks. I\'m passionate about helping aspiring developers grow their skills and advance their careers.',
  mentorExperience: [
    {
      company: 'Google',
      role: 'Senior Frontend Engineer',
      duration: '2019 - Present',
      description: 'Leading the frontend development for Google Cloud Platform products.',
    },
    {
      company: 'Facebook',
      role: 'Frontend Engineer',
      duration: '2016 - 2019',
      description: 'Worked on React and contributed to Facebook\'s internal design system.',
    },
    {
      company: 'Airbnb',
      role: 'Frontend Developer',
      duration: '2013 - 2016',
      description: 'Helped build and maintain Airbnb\'s user interface and booking system.',
    },
  ],
  mentorEducation: [
    {
  ...
  mentorSkills: [
    'React', 'TypeScript', 'JavaScript', 'HTML/CSS', 'Redux', 'GraphQL', 'Next.js', 'Unit Testing', 'Performance Optimization', 'UI/UX Design'
  ],
  mentorAchievements: [
  ...
  overview: 'Accelerate your frontend development career with personalized mentorship from a Google Senior Frontend Engineer.',
  description: 'This 12-week mentorship program is designed to help you master modern frontend development skills and advance your career. You\'ll receive personalized guidance, code reviews, career advice, and exclusive resources from a senior engineer with experience at top tech companies.\n\nWhether you\'re looking to break into tech, level up your skills, or prepare for senior roles, this program will provide you with the knowledge, feedback, and support you need to achieve your goals.',
  type: 'one-on-one',
  duration: '12 weeks',
  ...
  reviews: [
    {
      ...
      date: '2023-10-15',
      rating: 5,
      comment: 'Sarah\'s mentorship completely transformed my frontend skills and helped me land my dream job. Her guidance on React patterns and best practices was invaluable, and she gave me excellent feedback on my portfolio projects. The mock interviews we did prepared me perfectly for the real thing!'
    },
    {
      id: 'r2',
      name: 'Jennifer Lee',
    ...
    },
    {
      ...
      date: '2023-08-30',
      rating: 4,
      comment: 'This mentorship program offers excellent value for the price. Sarah is knowledgeable, patient, and genuinely invested in your success. I especially appreciated the code reviews and feedback on my projects. The only reason I\'m not giving 5 stars is that I wish the program was longer!'
    }
  ]
};
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-gray-600 mb-6">{mentorship.overview}</p>
              ...
              <div className="flex items-center mb-6">
                ...
                <div>
                  <h3 className="font-medium text-gray-900">{mentorship.mentorName}</h3>
              ...
              <div className="flex flex-wrap gap-4 mb-6">
                ...
                <div className="flex items-center bg-indigo-50 rounded-full px-4 py-2 text-sm text-indigo-700">
                  ...
                  {mentorship.type.split('-').map(word => word.charAt(0).toUpperCase() + word.slice(1)).join(' ')}
                </div>
                <div className="flex items-center bg-indigo-50 rounded-full px-4 py-2 text-sm text-indigo-700">
                  <svg className="w-5 h-5 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
              ...
              <div className="flex items-center mb-6">
                <span className="text-2xl font-bold text-gray-900 mr-4">{formatPrice(mentorship.price)}</span>
                <div className="text-sm text-gray-600 border-l border-gray-300 pl-4">
                  <div>{mentorship.enrolled} enrolled</div>
                  <div>{mentorship.capacity - mentorship.enrolled} spots left</div>
                </div>
              </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-white rounded-lg shadow-sm p-6 mb-8">
              <div className="flex items-center justify-between mb-6">
                ...
                <span className="bg-indigo-100 text-indigo-800 px-3 py-1 rounded-full text-sm font-medium">
                  {mentorship.reviews.reduce((acc, review) => acc + review.rating, 0) / mentorship.reviews.length} / 5
                </span>
              </div>
              
              <div className="space-y-6">
                {mentorship.reviews.map(review => (
                  <div key={review.id} className={`pb-6 ${review.id !== mentorship.reviews[mentorship.reviews.length - 1].id ? 'border-b border-gray-200' : ''}`}>
          ...
          <div>
            ...
            <div className="bg-white rounded-lg shadow-sm p-6 mb-8 sticky top-6">
              <h3 className="text-xl font-bold text-gray-900 mb-4">About Your Mentor</h3>
      ...
      <div className="bg-indigo-100">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          <div className="text-center">
            <h2 className="text-3xl font-bold text-indigo-900 mb-4">Ready to Accelerate Your Career?</h2>
            <p className="text-lg text-indigo-700 mb-8 max-w-3xl mx-auto">
              Apply now to join {mentorship.mentorName}'s mentorship program and take your skills to the next level.
              Only {mentorship.capacity - mentorship.enrolled} spots left!
            </p>
